...
import { Sparkles, BookOpen, LogOut, ArrowRight, Book, RefreshCw } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 bg-[#0f0f0f]/90 border-b border-white/10 backdrop-blur-md px-6 py-4 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          {fileHash && (
            ...
            >
              <div className="hidden md:flex items-center gap-2 text-xs border border-white/5 rounded-xl bg-[#161616] px-3.5 py-1.5 font-medium text-slate-400">
